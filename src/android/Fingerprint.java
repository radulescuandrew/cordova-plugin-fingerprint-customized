...
public class Fingerprint extends CordovaPlugin {
    ...
    private static String mLocalizedReason;
    ...
    public boolean execute(final String action,
        ...
        if (action.equals("authenticate")) {
            ...
            if (arg_object.has("localizedReason")) {
                mLocalizedReason = arg_object.getString("localizedReason");
            }
            // Set language
                ...
                if (key != null) {
                    cordova.getActivity().runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            bundle.putString("localizedReason", mLocalizedReason);
